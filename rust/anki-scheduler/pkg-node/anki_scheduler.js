/* @ts-self-types="./anki_scheduler.d.ts" */
 ...
 * @param {number} secs_until_rollover
 * @returns {number}
 */
function interval_secs(state_json, secs_until_rollover) {
    const ptr0 = passStringToWasm0(state_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.interval_secs(ptr0, len0, secs_until_rollover);
    return ret >>> 0;
}
exports.interval_secs = interval_secs;
 ...
 * @returns {string}
 */
function next_states(state_json, config_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(state_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const ret = wasm.next_states(ptr0, len0, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
const wasmPath = `${__dirname}/anki_scheduler_bg.wasm`;
