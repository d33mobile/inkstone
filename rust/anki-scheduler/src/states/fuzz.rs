...
impl StateContext<'_> {
    ...
    pub fn with_review_fuzz(&self, interval: f32, minimum: u32, maximum: u32) -> u32 {
...
pub fn constrained_fuzz_bounds(interval: f32, minimum: u32, maximum: u32) -> (u32, u32) {
...
pub fn fuzz_bounds(interval: f32) -> (u32, u32) {
