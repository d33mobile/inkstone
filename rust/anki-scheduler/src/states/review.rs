...
impl ReviewState {
    ...
    pub fn failing_review_interval(self, ctx: &StateContext) -> f32 {
    ...
    fn answer_again(self, ctx: &StateContext) -> CardState {
        ...
        let scheduled_days = self.failing_review_interval(ctx);
...
pub fn leech_threshold_met(lapses: u32, threshold: u32) -> bool {
    if threshold > 0 {
